...
Our first analysis of the data was analyzing the United States against other countries in different athletic events. We picked the United States because of the probability that we would get data for all four Olympics in our events. For each section of analyzing the United States we analyzed them against certain countries that we believed would do well in those events. In addition, we ended up regressing both GDP and Population on the medal count to see if our original hypothesis was correct.
